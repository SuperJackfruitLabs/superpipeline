...
Superpipeline is built **docs-first → test-first**. The normative tables in the specs are not
...
certify **"Superpipeline-compatible"** ([04 conformance](./04-agent-contract.md)). It drives the agent
