...
Superpipeline coordinates agents it does **not** run, on machines it does **not** control. So the central
...
5. **Two-tier gates** ([11](./11-prior-art-and-market-scan.md)): a stage may be a *soft* review column
   ...
   ([05 §7](./05-integration-surfaces.md)); a denied action surfaces to Superpipeline as an `elicitation`.
